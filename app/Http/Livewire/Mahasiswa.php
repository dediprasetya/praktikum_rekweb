...
public $nim, $nama, $alamat, $umur, $kota, $kelas, $jurusan, $updateMahasiswa = false, $addMahasiswa = false; // definisikan variabelnya dulu
...
\App\Models\Mahasiswa::whereNim($this->nim)->update([
